      ...
      if (input !== undefined && input !== null) {
         ...
         if (show) {
            ...
            for (key in $errors) {
               ...
               if ($this.location === null) {
                  if ($this.locations[$name] === undefined) {
                     input.parents(".form-group").find(".input-error").append("<" + $this.error_tag + ">" + $value + "</" + $this.error_tag + ">");
                  } else {
                     jQuery($this.locations[$name].replace("{{fieldname}}", $name)).append("<" + $this.error_tag + ">" + $value + "</" +  $this.error_tag + ">");
                  }
               } else {
                  jQuery($this.location.replace("{{fieldname}}", $name)).append("<" + $this.error_tag + ">" + $value + "</" + $this.error_tag + ">");
               }
